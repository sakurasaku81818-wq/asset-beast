...
${o.log}<br>
  ...
  `,S()}function x(e,t){return t>=120&&t<=240||e>=200&&e<=360}function S(){let e=document.querySelector(`#player`),t=240,n=320;e.style.left=t+`px`,e.style.top=n+`px`,document.onkeydown=r=>{if(r.key===`e`&&s){w(s);return}let i=t,a=n;(r.key===`ArrowRight`||r.key===`d`)&&(i+=40),(r.key===`ArrowLeft`||r.key===`a`)&&(i-=40),(r.key===`ArrowDown`||r.key===`s`)&&(a+=40),(r.key===`ArrowUp`||r.key===`w`)&&(a-=40),!(i<0||i>520||a<0||a>360)&&x(i,a)&&(t=i,n=a,e.style.left=t+`px`,e.style.top=n+`px`,C(t,n))};let r=document.querySelector(`#town`);if(r){let i=0,a=0,o=!1;r.addEventListener(`touchstart`,e=>{let t=e.touches[0];i=t.clientX,a=t.clientY,o=!1},{passive:!0}),r.addEventListener(`touchmove`,e=>{let t=e.touches[0],n=t.clientX-i,r=t.clientY-a;(Math.abs(n)>15||Math.abs(r)>15)&&(o=!0,e.preventDefault())},{passive:!1}),r.addEventListener(`touchend`,r=>{let c=r.changedTouches[0];C(t,n);let l=t,u=n;if(o){let e=c.clientX-i,t=c.clientY-a;Math.abs(e)>Math.abs(t)?l+=e>0?40:-40:u+=t>0?40:-40}else{let t=e.getBoundingClientRect(),n=t.left+t.width/2,r=t.top+t.height/2,i=c.clientX-n,a=c.clientY-r;Math.abs(i)>Math.abs(a)?l+=i>0?40:-40:u+=a>0?40:-40}if(!(l<0||l>520||u<0||u>360)&&x(l,u)&&(t=l,n=u,e.style.left=t+`px`,e.style.top=n+`px`,C(t,n),!o&&s)){w(s);return}},{passive:!0})}}function C(e,t){s=null,document.querySelectorAll(`.building`).forEach(n=>{let r=n.offsetLeft,i=n.offsetTop;Math.abs(e-r)<=40&&Math.abs(t-i)<=40&&(s=n.dataset.place)});let n=document.querySelector(`.message`);n&&(s?n.innerHTML=`
    ...
    `:n.innerHTML=`
      ...
      操作：タップ・スワイプで移動
      施設の近くでタップして入る
    `)}function w(e){e===`securities`&&T(),e===`realestate`&&O(),e===`home`&&B(),e===`work`&&A(),e===`school`&&z()}window.enterPlace=w;function T(){a.innerHTML=`
  ...
  `,document.querySelector(`#buyStock`).onclick=()=>E(`stock`),document.querySelector(`#sellStock`).onclick=()=>D(`stock`),document.querySelector(`#buyEtf`).onclick=()=>E(`etf`),document.querySelector(`#sellEtf`).onclick=()=>D(`etf`),document.querySelector(`#buyReit`).onclick=()=>E(`reit`),document.querySelector(`#sellReit`).onclick=()=>D(`reit`),document.querySelector(`#buyCrypto`).onclick=()=>E(`crypto`),document.querySelector(`#sellCrypto`).onclick=()=>D(`crypto`),document.querySelector(`#backTown`).onclick=b}function E(e){if(o.cash<1e5){alert(`現金が足りない`);return}o.cash-=1e5,o[e]+=1e5,o.log=`10万円分の資産を購入した。`,T()}function D(e){let t=1e5;if(o[e]<t){alert(`保有額が足りません`);return}o[e]-=t,o.cash+=t,o.log=`${{stock:`株`,etf:`ETF`,reit:`REIT`,crypto:`仮想通貨`}[e]}を10万円売却しました。`,T()}function O(){a.innerHTML=`
    <div class="screen shop-screen">
      <h2>🏠 不動産屋</h2>
...
<div class="card">
  ...
  `,document.querySelector(`#backTown`).onclick=b,document.querySelector(`#buyHouse`)&&(document.querySelector(`#buyHouse`).onclick=()=>k(`戸建て`,3e7)),document.querySelector(`#buyMansion`)&&(document.querySelector(`#buyMansion`).onclick=()=>k(`マンション`,45e6)),document.querySelector(`#buyApartment`)&&(document.querySelector(`#buyApartment`).onclick=()=>k(`アパート`,8e7))}function k(e,t){if(o.cash<t){alert(`資金が足りません`);return}o.cash-=t,o.house={name:e,purchasePrice:t,cost:0},o.propertyValue=t,o.log=`${e}を${d(t)}で購入しました。`,b()}function A(){a.innerHTML=`
    <div class="screen">
      <h2>🏢 仕事</h2>
  ...
  `,document.querySelector(`#startWork`).onclick=j,document.querySelector(`#backTown`).onclick=b}function j(){a.innerHTML=`
    <div class="screen">
      <h2>💼 お仕事チャレンジ</h2>
...
💰 ボーナス +10,000円
⭐ 仕事評価 ${o.workScore} / 5`)):alert(`残念！今回は評価を獲得できなかった…。`),A()}document.querySelector(`#workA`).onclick=()=>r(n[0]),document.querySelector(`#workB`).onclick=()=>r(n[1]),document.querySelector(`#workC`).onclick=()=>r(n[2]),document.querySelector(`#backWork`).onclick=A}function N(){let e=[{question:`住民から手続きについて質問された！`,choices:[`制度を確認して丁寧に案内する`,`分からないので適当に答える`,`他の窓口へ行くように伝える`],correct:0},{question:`書類に記入ミスを発見した！`,choices:[`そのまま処理する`,`内容を確認して修正をお願いする`,`書類を捨てる`],correct:1},{question:`窓口が混雑して住民が困っている！`,choices:[`自分のペースだけを優先する`,`休憩に行く`,`状況を見て周囲と協力して対応する`],correct:2},{question:`個人情報が書かれた書類を見つけた！`,choices:[`適切な場所に保管して報告する`,`机の上に置いておく`,`写真を撮る`],correct:0},{question:`新しい制度が始まることになった！`,choices:[`今まで通りの方法だけで仕事する`,`内容を確認して必要な知識を身につける`,`誰かが教えてくれるまで何もしない`],correct:1}],t=e[Math.floor(Math.random()*e.length)],n=t.choices.map((e,n)=>({text:e,correct:n===t.correct}));n.sort(()=>Math.random()-.5),a.innerHTML=`
    <div class="screen">
      <h2>🏛️ 公務員チャレンジ</h2>
...
💰 ボーナス +10,000円
⭐ 仕事評価 ${o.workScore} / 5`)):alert(`😣 今回は評価を獲得できなかった...`),A()}document.querySelector(`#workA`).onclick=()=>r(n[0]),document.querySelector(`#workB`).onclick=()=>r(n[1]),document.querySelector(`#workC`).onclick=()=>r(n[2]),document.querySelector(`#backWork`).onclick=A}function P(){let e=[{question:`リリース直前に重大なバグを発見した！`,choices:[`原因を確認してチームに報告する`,`気づかなかったことにする`,`とりあえずリリースする`],correct:0},{question:`プログラムが突然動かなくなった！`,choices:[`全部最初から作り直す`,`エラーログを確認して原因を調べる`,`パソコンを閉じる`],correct:1},{question:`納期が迫っているが作業が遅れている！`,choices:[`進捗と問題点をチームに共有する`,`黙って徹夜する`,`完成したことにする`],correct:0},{question:`知らない技術が必要になった！`,choices:[`できないと断る`,`適当にコードを書く`,`調べながら小さく試して学ぶ`],correct:2},{question:`同僚からコードレビューをお願いされた！`,choices:[`動けばいいのでOKを出す`,`目的を理解して改善点を伝える`,`全部自分の書き方に直させる`],correct:1}],t=e[Math.floor(Math.random()*e.length)],n=t.choices.map((e,n)=>({text:e,correct:n===t.correct}));n.sort(()=>Math.random()-.5),a.innerHTML=`
    <div class="screen">
      <h2>💻 エンジニアチャレンジ</h2>
...
💰 ボーナス +10,000円
⭐ 仕事評価 ${o.workScore} / 5`)):alert(`🐛 バグ発生！今回は評価を獲得できなかった...`),A()}document.querySelector(`#workA`).onclick=()=>r(n[0]),document.querySelector(`#workB`).onclick=()=>r(n[1]),document.querySelector(`#workC`).onclick=()=>r(n[2]),document.querySelector(`#backWork`).onclick=A}function F(){let e=[{place:`🏪 コンビニ`,question:`レジが混雑して長い列ができた！`,choices:[`落ち着いて素早くレジ対応する`,`気にせず品出しを続ける`,`バックヤードに逃げる`],correct:0,pay:7e3},{place:`💊 ドラッグストア`,question:`お客さんから商品の場所を聞かれた！`,choices:[`分からないので適当に教える`,`売り場を確認して案内する`,`他のお客さんに聞いてもらう`],correct:1,pay:7500},{place:`📦 日雇い・引越し`,question:`重い荷物を運ぶことになった！`,choices:[`無理して一人で持つ`,`持ち方を確認して必要なら二人で運ぶ`,`見なかったことにする`],correct:1,pay:1e4},{place:`🍔 飲食店`,question:`ランチタイムで注文が一気に入った！`,choices:[`優先順位を確認して仲間と連携する`,`自分の担当だけゆっくり進める`,`休憩に入る`],correct:0,pay:8e3},{place:`🏭 倉庫`,question:`出荷直前の商品に間違いを発見した！`,choices:[`時間がないのでそのまま出荷する`,`誰にも言わず棚に戻す`,`出荷を止めて確認・報告する`],correct:2,pay:9e3}],t=e[Math.floor(Math.random()*e.length)],n=t.choices.map((e,n)=>({text:e,correct:n===t.correct}));n.sort(()=>Math.random()-.5),a.innerHTML=`
    <div class="screen">
      <h2>🧢 フリーターチャレンジ</h2>
...
${t.place}
💰 最低日給 +3,000円
⭐ 評価は上がらなかった`)),A()}document.querySelector(`#workA`).onclick=()=>r(n[0]),document.querySelector(`#workB`).onclick=()=>r(n[1]),document.querySelector(`#workC`).onclick=()=>r(n[2]),document.querySelector(`#backWork`).onclick=A}function I(){return o.businessActionDone?(alert(`📅 今月の経営判断はすでに実行済みです。
次の月へ進んでください。`),!1):!0}function L(){o.businessActionDone=!0}function R(){let e=o.business;if(!e){alert(`事業データがありません`),A();return}let t=e.sales-e.expenses,n=`★`.repeat(Math.min(e.reputation,5))+`☆`.repeat(Math.max(5-e.reputation,0));a.innerHTML=`
    <div class="screen">
      <h2>🏢 ${e.type} 経営</h2>
  ...
  `,document.querySelector(`#businessAd`).onclick=()=>{if(!I())return;let t=3e4;if(o.cash<t){alert(`❌ 現金が足りません。広告には30,000円必要です。`);return}o.cash-=t;let n=1.05,r=1.15;e.type===`ネットショップ`?(n=1.12,r=1.22):e.type===`飲食店`?(n=1.06,r=1.16):e.type===`個人サービス`?(n=1.08,r=1.18):e.type===`小売店`&&(n=1.07,r=1.17);let i=n+Math.random()*(r-n),a=e.sales;e.sales=Math.round(e.sales*i),Math.random()<.25&&e.reputation<5&&(e.reputation+=1),o.job.income=e.sales-e.expenses,alert(`📣 広告キャンペーン成功！

広告費：-30,000円
月商：${d(a)} → ${d(e.sales)}
評判：${e.reputation} / 5`),L(),R()},document.querySelector(`#businessEquipment`).onclick=()=>{if(!I())return;let t=8e4;if(o.cash<t){alert(`❌ 現金が足りません。設備投資には80,000円必要です。`);return}o.cash-=t;let n=e.sales,r=e.expenses,i=1.06,a=.98;e.type===`飲食店`?(i=1.14,a=.94):e.type===`小売店`?(i=1.12,a=.95):e.type===`ネットショップ`?(i=1.08,a=.97):e.type===`個人サービス`&&(i=1.06,a=.98),e.sales=Math.round(e.sales*i),e.expenses=Math.round(e.expenses*a),o.job.income=e.sales-e.expenses,alert(`🔧 設備投資を実行！

投資額：-80,000円
月商：${d(n)} → ${d(e.sales)}
経費：${d(r)} → ${d(e.expenses)}`),L(),R()},document.querySelector(`#businessProduct`).onclick=()=>{if(!I())return;let t=1e5;if(o.cash<t){alert(`❌ 現金が足りません。開発には100,000円必要です。`);return}o.cash-=t;let n=.55,r=1.18,i=1.3;if(e.type===`個人サービス`?(n=.8,r=1.22,i=1.38):e.type===`ネットショップ`?(n=.7,r=1.2,i=1.35):e.type===`飲食店`?(n=.65,r=1.18,i=1.32):e.type===`小売店`&&(n=.6,r=1.18,i=1.3),Math.random()<n){let t=e.sales,n=r+Math.random()*(i-r);e.sales=Math.round(e.sales*n),e.reputation<5&&(e.reputation+=1),o.job.income=e.sales-e.expenses,alert(`🆕 新商品・サービス開発成功！
...
月商：${d(t)} → ${d(e.sales)}
評判：${e.reputation} / 5`);L(),R()},document.querySelector(`#businessHire`).onclick=()=>{if(!I())return;let t=5e4;if(o.cash<t){alert(`❌ 現金が足りません。採用には50,000円必要です。`);return}if(e.employees>=5){alert(`👥 現在は5人まで雇えます。`);return}o.cash-=t;let n=e.sales,r=e.expenses;e.employees+=1,e.expenses+=4e4;let i=1.08;e.type===`飲食店`?i=1.2:e.type===`小売店`?i=1.18:e.type===`個人サービス`?i=1.12:e.type===`ネットショップ`&&(i=1.08),e.sales=Math.round(e.sales*i),o.job.income=e.sales-e.expenses,alert(`👥 従業員を1人採用！

採用費：-50,000円
従業員：${e.employees}人
月商：${d(n)} → ${d(e.sales)}
経費：${d(r)} → ${d(e.expenses)}`),L(),R()},document.querySelector(`#businessNormal`).onclick=()=>{if(!I())return;let t=e.sales,n=.97,r=1.03,i=.15;e.type===`飲食店`?(n=.96,r=1.04,i=.2):e.type===`ネットショップ`?(n=.98,r=1.03,i=.1):e.type===`個人サービス`?(n=.98,r=1.04,i=.25):e.type===`小売店`&&(n=.97,r=1.04,i=.15);let a=n+Math.random()*(r-n);e.sales=Math.round(e.sales*a),Math.random()<i&&e.reputation<5&&(e.reputation+=1),o.job.income=e.sales-e.expenses;let s=e.sales-t;alert(`🏪 通常営業終了！

月商：${d(t)} → ${d(e.sales)}
変化：${s>=0?`+`:``}${d(s)}
評判：${e.reputation} / 5`),L(),R()},document.querySelector(`#backWork`).onclick=A}function z(){a.innerHTML=`
    <div class="screen">
      <h2>🎓 学校</h2>
  ...
  `,document.querySelector(`#studyFP`).onclick=H,document.querySelector(`#backTown`).onclick=b}function B(){a.innerHTML=`
    <div class="screen">
      <h2>🏡 自宅</h2>
      <p>家で休むと1ヶ月が進みます。</p>
...
💬 格言：${_}<br>
📰 ${g.text}
`,o.age>=50){q();return}b()}window.nextMonth=V;function H(){let t=e[Math.floor(Math.random()*e.length)];a.innerHTML=`
    <div class="screen">
      <h2>🎓 FPクイズ</h2>
      <p>所持金：${d(o.cash)}</p>
      <p>${t.question}</p>
