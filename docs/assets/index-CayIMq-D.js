...
💰 ボーナス +10,000円
⭐ 仕事評価 ${o.workScore} / 5`)):alert(`残念！今回は評価を獲得できなかった…。`),k()}document.querySelector(`#workA`).onclick=()=>r(n[0]),document.querySelector(`#workB`).onclick=()=>r(n[1]),document.querySelector(`#workC`).onclick=()=>r(n[2]),document.querySelector(`#backWork`).onclick=k}function M(){a.innerHTML=`
    <div class="screen">
      <h2>🎓 学校</h2>
