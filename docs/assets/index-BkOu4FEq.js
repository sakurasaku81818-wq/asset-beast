...
<div class="card">
  ...
  `,document.querySelector(`#workA`).onclick=()=>{alert(`成功！上司からの評価が上がった！`)},document.querySelector(`#workB`).onclick=()=>{alert(`失敗！同僚からの信頼が下がった…。`)},document.querySelector(`#workC`).onclick=()=>{alert(`失敗！締め切りに間に合わなかった…。`)},document.querySelector(`#backWork`).onclick=k}function M(){a.innerHTML=`
    <div class="screen">
      <h2>🎓 学校</h2>
